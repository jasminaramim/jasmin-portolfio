    ...
    <section className="py-20 px-6 max-w-7xl mx-auto bg-transparent overflow-hidden">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div className="relative">
          ...
          >
            <span className="text-[#FF69B4] drop-shadow-[0_0_8px_rgba(255,105,180,0.5)]">🏆</span> 
            My <span className="text-[#FF69B4]">Experience</span>
          </motion.h2>

          <div className="relative border-l border-[#FF69B4]/30 ml-4 pl-10 space-y-10">
            {experience.map((exp: any, idx) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-2">
                  <span className="text-[#FF69B4] font-black text-[9px] uppercase tracking-[0.2em]">
                    {exp.period}
                  </span>
                ...
                <div className="text-gray-400 font-bold mb-3 text-[11px] uppercase tracking-widest italic">
                  {exp.companyLink ? (
                    <a href={exp.companyLink} target="_blank" rel="noreferrer" className="hover:text-[#FF69B4] transition-colors">
                      {exp.company}
                    </a>
                  ) : exp.company}
                </div>
        ...
        <div className="relative mt-20 lg:mt-0">
          ...
          >
            <span className="text-[#FF69B4] drop-shadow-[0_0_8px_rgba(255,105,180,0.5)]">🎓</span> 
            My <span className="text-[#FF69B4]">Education</span>
          </motion.h2>
