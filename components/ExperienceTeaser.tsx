      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#FF69B4] to-[#c850c0]">Education</span>
          </motion.h2>
        </div>

        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          <div className="space-y-6">
            <h3 className="text-[12px] font-bold text-[#e03a7a] uppercase tracking-[0.2em] flex items-center gap-4 mb-4">
              <span className="w-10 h-[2px] bg-[#e03a7a]"></span> LATEST EXP
            </h3>
            <div className="space-y-6">
              {recentExp.map((exp, idx) => (
                <motion.div 
                  ...
                  className="relative p-7 md:p-8 bg-[rgba(255,255,255,0.02)] border border-[rgba(200,80,192,0.3)] rounded-[16px] hover:bg-[rgba(255,255,255,0.04)] transition-all"
                >
                  <div className="absolute left-0 top-[20%] bottom-[20%] w-[3px] bg-gradient-to-b from-[#c850c0] to-[#6366f1] rounded-r-md"></div>
                  <span className="text-[#e03a7a] font-black text-[10px] uppercase tracking-[0.15em] block mb-2">{exp.period}</span>
          ...
          <div className="space-y-6 mt-10 lg:mt-0">
            <h3 className="text-[12px] font-bold text-[#e03a7a] uppercase tracking-[0.2em] flex items-center gap-4 mb-4">
              <span className="w-10 h-[2px] bg-[#e03a7a]"></span> EDUCATION
            </h3>
            <div className="space-y-6">
              {recentEdu.map((edu, idx) => (
                ...
                >
                  <div className="absolute left-0 top-[20%] bottom-[20%] w-[3px] bg-gradient-to-b from-[#c850c0] to-[#6366f1] rounded-r-md"></div>
                  <span className="text-[#e03a7a] font-black text-[10px] uppercase tracking-[0.15em] block mb-2">{edu.period}</span>
        ...
        <div className="flex justify-center">
          <motion.button 
            ...
            className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#e03a7a] to-[#c850c0] text-white font-black uppercase tracking-[0.15em] text-[12px] shadow-[0_0_20px_rgba(200,80,192,0.3)] rounded-full hover:opacity-90 transition-opacity"
          >
            Read More History 
